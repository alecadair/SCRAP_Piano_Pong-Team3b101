...
xst -ifn xst.scr
move pixelClock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pixelClock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pixelClock_exdes.ucf pixelClock_exdes

echo 'Running map'
map -timing -pr b pixelClock_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pixelClock_exdes -w routed.ncd routed.v
cd ..
